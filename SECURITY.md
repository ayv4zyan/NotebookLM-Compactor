...
| Rate-conscious requests | Minimum spacing between NotebookLM RPC calls in the API handler |
...
User on notebooklm.google.com
  ...
  → content script calls batchexecute in-page (user session cookies)
  → optional fallback via background worker message routing
